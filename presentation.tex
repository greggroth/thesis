...
\frametitle{fMRI and BOLD}
  What is the BOLD.  How does fMRI measure it?
}
...
\frametitle{The Balloon Model}
  \centering
  \resizebox{\textwidth}{!}{%
    \includegraphics[width=\linewidth]{figures/balloon-model-rastor}
  }
}
...
\frametitle{The Segmented Head}
  ...
  \medskip
  \tiny{
  \begin{tabular*}{\linewidth}{@{} l p{1.6cm}p{1cm}p{1.6cm}p{1.6cm}l@{}}
	  \toprule
