...
\begin{tikzpicture}[node distance=0.7cm, rectangle, text width=4.5cm, text badly centered, rounded corners, minimum height=1cm, anchor=north]
  ...
  \node[block, below=of excitatory](cbf){Increase in Cerebral Blood Flow, $f(t)$};
  \node[block, below=of inhibitory, xshift=-3cm](o2){Change in Oxygen Consumption, $m(t)$};
  ...
  \path[line](cbf.south) |- (bold.west);
  \path[line](cbf.south) |- (temp.west);
  \path[line](o2.south)  |- (bold.east);
  \path[line](o2.south)  |- (temp.east);
